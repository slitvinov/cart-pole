...
*/
int
_shrinkSurfaceRGBA(SDL_Surface * src, SDL_Surface * dst, int factorx,
                   int factory)
{
...
*/
int
_shrinkSurfaceY(SDL_Surface * src, SDL_Surface * dst, int factorx,
                int factory)
{
...
*/
int
_zoomSurfaceRGBA(SDL_Surface * src, SDL_Surface * dst, int flipx,
                 int flipy, int smooth)
{
    int x, y, sx, sy, ssx, ssy, *sax, *say, *csax, *csay, *salast, csx,
        csy, ex, ey, cx, cy, sstep, sstepx, sstepy;
...
*/
int
_zoomSurfaceY(SDL_Surface * src, SDL_Surface * dst, int flipx, int flipy)
{
    int x, y;
...
*/
void
_transformSurfaceRGBA(SDL_Surface * src, SDL_Surface * dst, int cx, int cy,
...
*/
SDL_Surface *
rotateSurface90Degrees(SDL_Surface * src, int numClockwiseTurns)
{
    ...
    dst =
        SDL_CreateRGBSurface(src->flags, newWidth, newHeight,
    ...
    case 1:                    /* rotated 90 degrees clockwise */
        {
            for (row = 0; row < src->h; ++row) {
                ...
                dstBuf =
                    (Uint8 *) (dst->pixels) + (dst->w - row - 1) * bpp;
...
*/
void
_rotozoomSurfaceSizeTrig(int width, int height, double angle, double zoomx,
...
*/
void
rotozoomSurfaceSizeXY(int width, int height, double angle, double zoomx,
                      double zoomy, int *dstwidth, int *dstheight)
{
    double dummy_sanglezoom, dummy_canglezoom;

    _rotozoomSurfaceSizeTrig(width, height, angle, zoomx, zoomy, dstwidth,
                             dstheight, &dummy_sanglezoom,
                             &dummy_canglezoom);
}
...
SDL_Surface *
rotozoomSurfaceXY(SDL_Surface * src, double angle, double zoomx,
                  double zoomy, int smooth)
{
    ...
    if (fabs(angle) > VALUE_LIMIT) {
        ...
        if (is32bit) {
             ...
             */
            rz_dst =
                SDL_CreateRGBSurface(SDL_SWSURFACE, dstwidth,
                                     dstheight + GUARD_ROWS, 32,
                                     rz_src->format->Rmask,
                                     rz_src->format->Gmask,
                                     rz_src->format->Bmask,
                                     rz_src->format->Amask);
        ...
        if (is32bit) {
             ...
             */
            _transformSurfaceRGBA(rz_src, rz_dst, dstwidthhalf,
                                  dstheighthalf, (int) (sanglezoominv),
...
/*@null@*/
SDL_Surface *
shrinkSurface(SDL_Surface * src, int factorx, int factory)
{
    int result;
    SDL_Surface *rz_src;
