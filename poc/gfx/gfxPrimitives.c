...
*/ 
    ...
    Sint16 last1x, last1y, last2x, last2y, first1x, first1y, first2x,
        first2y, tempx, tempy;
...
rectangleColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
    ...
    return rectangleRGBA(renderer, x1, y1, x2, y2, c[0], c[1], c[2],
                          c[3]);
...
roundedRectangleColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1,
                      ...
                      Uint32 color)  { Uint8 * c = (Uint8 *) & color;
    return roundedRectangleRGBA(renderer, x1, y1, x2, y2, rad, c[0], c[1],
                                 c[2], c[3]);
...
roundedBoxColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
        ...
        (Uint8 *) & color;
    return roundedBoxRGBA(renderer, x1, y1, x2, y2, rad, c[0], c[1], c[2],
                           c[3]);
...
aalineColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
            Sint16 y2, Uint32 color)  { Uint8 * c = (Uint8 *) & color;
    return _aalineRGBA(renderer, x1, y1, x2, y2, c[0], c[1], c[2], c[3],
                        1);
...
aalineRGBA(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
           Sint16 y2, Uint8 r, Uint8 g, Uint8 b,
           Uint8 a)  { return _aalineRGBA(renderer, x1, y1, x2, y2, r, g,
                                            b, a, 1);
...
circleRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
           ...
           Uint8 a)  { return ellipseRGBA(renderer, x, y, rad, rad, r, g,
                                            b, a);
...
arcColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
        ...
        (Uint8 *) & color;
    return arcRGBA(renderer, x, y, rad, start, end, c[0], c[1], c[2],
                    c[3]);
...
aacircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
              Uint32 color)  { Uint8 * c = (Uint8 *) & color;
    return aaellipseRGBA(renderer, x, y, rad, rad, c[0], c[1], c[2],
                          c[3]);
...
ellipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx,
    ...
    return _ellipseRGBA(renderer, x, y, rx, ry, c[0], c[1], c[2], c[3],
                         0);
...
ellipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx,
            ...
            Uint8 a)  { return _ellipseRGBA(renderer, x, y, rx, ry, r, g,
                                              b, a, 0);
...
filledCircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
                  Uint32 color)  { Uint8 * c = (Uint8 *) & color;
    return filledEllipseRGBA(renderer, x, y, rad, rad, c[0], c[1], c[2],
                              c[3]);
...
filledCircleRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
                 Uint8 r, Uint8 g, Uint8 b,
                 Uint8 a)  { return _ellipseRGBA(renderer, x, y, rad,
                                                   rad, r, g, b, a, 1);
...
filledEllipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx,
                  Sint16 ry, Uint8 r, Uint8 g, Uint8 b,
                  Uint8 a)  { return _ellipseRGBA(renderer, x, y, rx, ry,
                                                    r, g, b, a, 1);
...
pieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
        ...
        (Uint8 *) & color;
    return _pieRGBA(renderer, x, y, rad, start, end, c[0], c[1], c[2],
                     c[3], 0);
...
pieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
        ...
        Uint8 a)  { return _pieRGBA(renderer, x, y, rad, start, end, r,
                                      g, b, a, 0);
...
filledPieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
              ...
              Uint8 a)  { return _pieRGBA(renderer, x, y, rad, start,
                                            end, r, g, b, a, 1);
...
filledPolygonColor(SDL_Renderer * renderer, const Sint16 * vx,
                   const Sint16 * vy, int n, Uint32 color)  { Uint8 * c =
        (Uint8 *) & color;
    return filledPolygonRGBAMT(renderer, vx, vy, n, c[0], c[1], c[2],
                                c[3], NULL, NULL);
...
filledPolygonRGBA(SDL_Renderer * renderer, const Sint16 * vx,
                  const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b,
                  Uint8 a)  { return filledPolygonRGBAMT(renderer, vx,
                                                           vy, n, r, g, b,
                                                           a, NULL, NULL);
...
thickLineColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
        ...
        (Uint8 *) & color;
    return thickLineRGBA(renderer, x1, y1, x2, y2, width, c[0], c[1],
                          c[2], c[3]);
...
thickLineRGBA(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
        ...
        return boxRGBA(renderer, x1 - wh, y1 - wh, x2 + width, y2 + width,
                        r, g, b, a);
